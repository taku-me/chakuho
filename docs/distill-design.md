...
| Ableton コマンド解析 1,550 問 | 日本語 1 行 → track/clip/scene | **74%** | 66%(Jev は 91%) |
...
- **ただし同じ母集団で Jev は 1407/1550 = 90.8%**(noul 反転 2.8%)。**訓練領域の外では Jev が 16 ポイント上で、
  埋め切れていない。** 「Jev と同等」が成り立つのは GUI 要素選択の中だけ
